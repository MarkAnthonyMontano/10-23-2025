            ...
            <TableContainer component={Paper} sx={{ width: "100%" }}>
                <Table size="small">
                    ...
                    >
                            ...
                            {documentOptions.length === 0 ? (
                                ...
                                >
                                    {documentOptions.map((doc) => {
                                        ...
                                        // ✅ Determine if this document is missing or not
                                        const isMissing = selectedArray.includes(doc.key);
                                        ...
                                        return (
                                            <FormControlLabel
                                                ...
                                                control={
                                                    <Checkbox
                                                        checked={!isMissing} // checked = has document, unchecked = missing
                                                        disabled // always disabled (view only)
                                                    />
                                                }
                                                label={doc.label}
                                                sx={{
                        ...
                        <DialogActions>
                            <Button onClick={handleCloseDialog} variant="contained" sx={{ background: "maroon" }}>
                                Close
                            </Button>
                        </DialogActions>
                    </Dialog>
